...
export default function Home() {
  ...
  return (
    <>
      ...
      <a href=" https://drive.google.com/file/d/1LY_hHypCCN01aukb6hV5Pe_b-y92r04Q/view?usp=drivesdk" target="_blank" rel="noopener noreferrer">
        ...
        <div className="flex flex-col items-start  sm:w-[70%] md:w-[50%] text-white px-4 md:px-0">
          ...
          <div className="flex flex-row items-start pt-20">
            ...
            <span className="relative text-5xl md:text-6xl font-bold mt-1 md:mt-2 md:pt-2 text-[#ffffff]">
              havya <span className="hidden md:inline "> Bhosale </span>
              <br />
  ...
  <img src="./bb1.png" alt="Bhavya Bhosale" width={600} height={600} className="" />
